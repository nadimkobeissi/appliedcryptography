...
\begin{questions}
	...
	\begin{randomizechoices}
		\CorrectChoice Encrypting all key material with AES-ECB and no integrity protection
		\choice Using RSA key pairs that were too short
	...
	\begin{randomizechoices}
		...
		\CorrectChoice A protocol where the client gets $F(k, x)$ without the server learning $x$
	...
	\begin{randomizechoices}
		...
		\CorrectChoice It's error-prone for humans compared to mnemonic phrases with checksums
	...
	\begin{randomizechoices}
		\choice The server can test password guesses offline
		\CorrectChoice The server sees only random group elements and learns nothing about the password
	...
	\begin{randomizechoices}
		...
		\CorrectChoice The client's private key encrypted with a password-derived key
...
\quizanswerkey{STORE YOUR [Files] IN MY [Cloud]!! EVEN I CAN'T READ THEM, AND BELIEVE ME, I'VE [TRIED]!!}
