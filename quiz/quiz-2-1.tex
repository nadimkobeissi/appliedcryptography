...
\begin{questions}
	...
	\begin{randomizechoices}
		...
		\CorrectChoice A list of supported cipher suites and a Diffie-Hellman public key
	\end{randomizechoices}
	...
	\question How many round trips does a standard TLS 1.3 handshake require before encrypted data can be sent?
	\begin{randomizechoices}
...
\quizanswerkey[jevil]{A HANDSHAKE, HANDSHAKE!! KEYS AGREED, CERTIFICATES CHECKED, NOW NOBODY HEARS YOU BUT ME, ME... KIDDING!! UEE HEE HEE!!}
