...
\begin{questions}
	...
	\begin{randomizechoices}
		\CorrectChoice Observing that the XOR of the outputs' left halves equals the XOR of the inputs' left halves when inputs share the same right half
	...
	\begin{randomizechoices}
		...
		\CorrectChoice It is computationally indistinguishable from a uniform distribution
	\end{randomizechoices}
...
\quizanswerkey{THEY CALL MY SPEECH [Random Garbage]!! WRONG!! IT'S [Pseudorandom] GARBAGE!! NO EFFICIENT [Distinguisher] CAN TELL!!}
