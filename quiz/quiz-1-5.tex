...
\begin{questions}
	...
	\begin{randomizechoices}
		...
		\CorrectChoice It is malleable - bit flips in the ciphertext cause predictable changes in the plaintext
	...
	\begin{randomizechoices}
		...
		\CorrectChoice CCA protects against adversaries with access to a decryption oracle for ciphertexts of their choice
	...
	\question Which method of combining encryption with a MAC is always CCA-secure?
	\begin{randomizechoices}
	...
	\begin{randomizechoices}
		...
		\CorrectChoice The MAC is computed on the plaintext, leaking equality information
	\end{randomizechoices}
	...
	\begin{randomizechoices}
		...
		\CorrectChoice Converts CPA-secure public-key encryption to CCA-secure public-key encryption
...
\quizanswerkey[jevil]{QUERY, QUERY MY ORACLE, LIGHTNERS!! CHOOSE ANY PLAINTEXT YOU PLEASE --- THE KEY STAYS HIDDEN FROM THE EYES!!}
