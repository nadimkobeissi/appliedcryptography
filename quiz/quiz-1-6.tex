...
\begin{questions}
	...
	\question Which researcher demonstrated the first practical MD5 collision in 2004?
	\begin{randomizechoices}
	...
	\begin{randomizechoices}
		...
		\CorrectChoice They must exist when infinitely many inputs map to finitely many outputs
	...
	\question What was surprising about Joux's multi-collision attack?
	\begin{randomizechoices}
		\choice Multi-collisions are impossible to find
		\choice Finding multi-collisions takes exponentially more work
		\CorrectChoice Finding $2^n$ colliding messages takes only about $n$ times the work of finding one collision
	\end{randomizechoices}
...
\quizanswerkey{TWO INPUTS, ONE [Digest]?? THAT'S NOT A [2-For-1 Deal], THAT'S A [COLLISION]!!}
