...
\begin{questions}
	...
	\question What happens when you replace XOR with AND in the one-time pad?
	\begin{randomizechoices}
	...
	\question What does AES-256 mean in terms of the security parameter?
	\begin{randomizechoices}
...
\quizanswerkey[jevil]{UEE HEE HEE! SECURITY IS JUST A SIMPLE NUMBERS GAME, GAME!! WHEN YOUR ADVANTAGE DROPS TO NEGLIGIBLE, YOU LOSE!!}
