...
\begin{questions}
	...
	\begin{randomizechoices}
		\CorrectChoice $c = \text{Hash}(X, Y)$ where $X$ is the instance and $Y$ is the commitment
	...
	\begin{randomizechoices}
		\CorrectChoice Proof generation time reduced from ${\sim}40$ seconds to ${\sim}2.5$ seconds
...
\quizanswerkey{I CAN CONVINCE YOU OF [Anything] WHILE TELLING YOU [Nothing]!! IT'S THE PERFECT [Sales Pitch]!!}
