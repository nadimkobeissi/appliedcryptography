		...
		\begin{center}
			\begin{tikzpicture}[
				...
				\node[box, right=2cm of adversary](attack){
					$\underline{\sslibraryfun{Attack}{M}}$: \hfill \quad \quad \textcolor{gray}{\scriptsize \textit{// adversary chooses $M$}} \\
		...
		\begin{columns}[c]
			...
			\begin{column}{0.6\textwidth}
				\begin{flushright}
					\sslinked{
						\ssprogram{}{
							$C_1 \coloneq \sslibraryfun{Otp.Enc}{\bit{0}^n}$\\
							$C_2 \coloneq \sslibraryfun{Otp.Enc}{\bit{0}^n}$\\
							return $C_1 == C_2$
						}{1}
					}{\link}{
						\sslibrary{}{a}{
		...
		\begin{columns}[c]
			\begin{column}{0.5\textwidth}
				\begin{itemize}[<+->]
					...
					\item \ssprogram{}{
						$M \coloneq \bit{0}^n$\\
						$C \coloneq \sslibraryfun{Ots.Enc}{M}$\\
						return $C == \bit{0}^n$
					}{1}
