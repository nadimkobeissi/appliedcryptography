	...
	\begin{columns}[c]
		\begin{column}{0.5\textwidth}
			\begin{itemize}
				...
				\item Instant messaging (Signal, Slack)
...
\begin{frame}{TLS Record fields breakdown}
	\begin{itemize}
		...
		\item \textbf{Bytes 2-3 - ProtocolVersion}:
		      \begin{itemize}
			      \item \texttt{03 03} in TLS 1.2 and 1.3 (historical reasons)
			      \item TLS 1.3 reuses TLS 1.2's value for compatibility
		      \end{itemize}
...
\begin{frame}{Nonces: Ensuring unique encryption}
	\begin{itemize}
		...
		\item \textbf{TLS solution}: Derive nonces from sequence numbers.
		      \begin{itemize}
			      \item Each party maintains a 64-bit sequence number.
