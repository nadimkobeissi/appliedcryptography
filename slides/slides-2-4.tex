...
\begin{frame}{OPAQUE: Next-generation password authentication}
	\begin{itemize}
		...
		\item \textbf{Key innovation:} Oblivious PRF (OPRF)
		      ...
		      \end{itemize}
		\item Being standardized by IETF (OPRF component: RFC 9497)
...
\begin{frame}{Comparing authentication approaches}
	\begin{columns}
		...
		\begin{column}{0.33\textwidth}
			...
			\vspace{0.3cm}
			\begin{itemize}
				\item[\textcolor{green}{\mycheckmark}] No eavesdropper offline attacks
...
\begin{frame}{A formal treatment: Building blocks}
	\begin{columns}[c]
		\begin{column}{1\textwidth}
			...
			\begin{itemize}
				\item \textbf{PRF (Pseudorandom Function):} $F: \{0,1\}^{\kappa} \times \{0,1\}^* \to \{0,1\}^{\kappa}$
