	...
	\begin{columns}[c]
		\begin{column}{1\textwidth}
			\begin{itemize}
				...
				\item Apple prioritized user choice over mandatory E2EE
			\end{itemize}
		\end{column}
	\end{columns}
\end{frame}
...
\begin{frame}{Using passkeys for key management}{Quick aside}
	\begin{itemize}
		...
		\item Current limitations:
		      ...
		      \end{itemize}
		\item Represents a potential future direction for usable E2EE key management and authentication more generally
	\end{itemize}
\end{frame}
		...
		\begin{column}{1\textwidth}
			\begin{itemize}
				...
				\item \textbf{Should use:} Argon2, scrypt, or PBKDF2
				      \begin{itemize}
					      \item Memory-hard (Argon2, scrypt) or iterative (PBKDF2) functions
					      \item Configurable iteration counts
					      \item Resistance to GPU/ASIC attacks (especially memory-hard functions)
				      \end{itemize}
...
\begin{frame}{OPAQUE: Next-generation password authentication}
	\begin{itemize}
		...
		\item \textbf{Key innovation:} Oblivious PRF (OPRF)
		      ...
		      \end{itemize}
		\item Being standardized by the IETF (OPRF component: RFC 9497)
		...
		\begin{column}{0.5\textwidth}
			\begin{itemize}
				\item \textbf{Why 64 digits?}
				      \begin{itemize}
					      \item 64 digits = ${\sim}$212 bits of entropy
					      \item Much more than needed for a 128-bit AES key
			...
			\begin{itemize}
				\item \textbf{Possible explanations:}
				      \begin{itemize}
					      ...
					      \item Or maybe using passphrases is just hard to localize into many languages
				      \end{itemize}
			\end{itemize}
		\end{column}
	\end{columns}
...
\begin{frame}{Reminder: formal analysis}
	\begin{columns}[c]
		\begin{column}{0.5\textwidth}
			\begin{itemize}
				\item \textbf{What is formal analysis?}\footnote{Coming soon in our topic sessions on High-Assurance Cryptography!}
				      \begin{itemize}
