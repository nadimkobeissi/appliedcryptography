...
\begin{document}
	...
	\begin{frame}{Defining Cryptography}
		\begin{columns}[c]
			\begin{column}{0.5\textwidth}
				\definitionbox{What is Cryptography?}{\textit{"The practice and study of techniques for secure communication in the presence of adversarial behavior."} \\[0.5em] — Ronald Rivest}
			\end{column}
	...
	\begin{frame}{Why bother?}
		...
		\end{itemize}
		\begin{alertblock}{The Problem with Traditional Access Control}
			\begin{itemize}
				\pause

				\item Requires trusting the server completely \pause

				\item No protection during transmission \pause

				\item No way to verify integrity \pause
	...
	\begin{frame}[c]{The Magic of Cryptography}
		\begin{center}
			...
			\begin{itemize}
				...
				\item Secure communication over insecure channels \pause

				\item Verification without revealing secrets \pause
	...
	\begin{frame}{Symmetric primitive example: hash functions}
		\begin{columns}[c]
			\begin{column}{0.55\textwidth}
				\definitionbox{Hash Function Properties}{\begin{itemize}\item Takes input of \textbf{any size}
			...
			\begin{column}{0.45\textwidth}
				\begin{tcolorbox}
					[colback=black!5!white,colframe=ciphergray] $\mathsf{SHA256}(\texttt{hello
					}) =$ \\ \texttt{2cf24dba5fb0a30e26e83b2ac5}\\ \texttt{b9e29e1b161e5c1fa7425e7304}\\
					\texttt{3362938b9824}
	...
	\begin{frame}{Class materials}
		\begin{itemize}
			\item \textbf{Joy of Cryptography}: learn about the math, how to reason
				about and prove systems secure.
