	...
	\begin{columns}[c]
		\begin{column}{1\textwidth}
			\begin{itemize}[<+->]
				...
				\item Example: Lucky Thirteen attack against TLS revealed message contents through timing differences.\footnote{\url{https://appliedcryptography.page/papers/\#rhul-luckythirteen}}
			\end{itemize}
		\end{column}
	\end{columns}
\end{frame}
