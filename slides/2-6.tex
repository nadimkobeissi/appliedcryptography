			...
			\begin{itemize}
				...
				\item \textbf{Example}: McEliece (hardness of decoding a linear code with insufficient information)
				      \begin{itemize}
					      ...
					      \item And the claim of NP-hardness even here is debated\ldots\footnote{Eurocrypt 2025 paper found a subexponential distinguisher for McEliece: \url{https://appliedcryptography.page/papers/\#syzygy-distinguisher.pdf}}
				      \end{itemize}
