...
\begin{frame}{Reconciliation: Getting exact agreement}
	\begin{itemize}
		...
		\item \textbf{Example} (if $q = 12$):
		      \begin{itemize}
			      \item Regions: $[0,2], [3,5], [6,8], [9,11]$ $\rightarrow$ bits: \bit{00}, \bit{01}, \bit{10}, \bit{11}
			      \item Alice has 5, Bob has 4 $\rightarrow$ both round to region $[3,5]$ $\rightarrow$ key bits: \bit{01}
		      \end{itemize}
	\end{itemize}
\end{frame}
