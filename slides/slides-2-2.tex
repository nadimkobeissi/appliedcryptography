	...
	\begin{itemize}
		\item A cryptographic tale of triumph and tragedy
		      \begin{itemize}
			      ...
			      \item \textbf{Golden Era (1990s--2000s):} Powered WEP, SSL, and TLS protocols globally
			      \item \textbf{Decline (2001--2015):} A series of devastating cryptanalytic breakthroughs
			      \item \textbf{Demise (2015):} Formal prohibition by the IETF and browser vendors
		      \end{itemize}
...
\begin{frame}{Origins of RC4}
	\begin{itemize}
		\item \textbf{1987:} Ron Rivest designs RC4 at RSA Security
		      ...
		      \end{itemize}
		\item \textbf{1994:} Algorithm anonymously posted to the Cypherpunks mailing list
		      \begin{itemize}
		...
		\item \textbf{Impact of the leak:}
		      \begin{itemize}
			      ...
			      \item Ironically helped RSA by making its cipher ubiquitous
		      \end{itemize}
	\end{itemize}
\end{frame}
...
\begin{frame}{$\mathsf{PRP}: F_{k}\colon X \rightarrow X$}{Reminder}
	\begin{columns}[c]
	...
	\begin{itemize}
		...
		\item \textbf{Ubiquitous protocol adoption:}
		      \begin{itemize}
			      ...
			      \item \textbf{SSL 3.0/TLS 1.0 (1996--1999):} RC4 as preferred cipher suite
		...
		\item \textbf{Why RC4 dominated:}
		      \begin{itemize}
			      ...
			      \item Fewer export restrictions than strong block ciphers
...
\begin{frame}{Early RC4 weaknesses (1995--2000)}
	\begin{itemize}
		\item \textbf{1995:} Roos discovered correlations between key bytes and initial permutation
		      \begin{itemize}
			      \item Found that RC4's key scheduling leaks information about the key
			      \item Wagner and Goldberg identified flaws in SSL 3.0's use of RC4
			      \item Seemed like minor curiosities at the time\ldots
		      \end{itemize}
		\item \textbf{1997:} Goli\'{c} discovered more biases in the keystream
		      \begin{itemize}
...
\begin{frame}{In fact\ldots}
	\bigimagewithcaption{rc4-bias.png}{Source: Kenny Paterson}
\end{frame}
		...
		\begin{column}{1\textwidth}
			\begin{itemize}
				...
				\item \textbf{Vulnerable design choice:} Initialization Vectors (IVs)
				      ...
				      \end{itemize}
				\item \textbf{The break:} This creates exactly the conditions the FMS (Fluhrer, Mantin, Shamir) attack exploited
				      \begin{itemize}
...
\begin{frame}{WEP's IV structure}
	...
	\end{center}
	\begin{itemize}
		\item \textbf{The FMS Attack:} Exploits weak IV patterns of the form $(A+3, 255, x)$
		...
		\item \textbf{Collection:} Need multiple matching IVs per key byte for a statistical attack
...
\begin{frame}{RC4 in TLS: from preferred to prohibited}
	\begin{itemize}
		...
		\item \textbf{The irony:} Avoiding one attack led directly into another
		      \begin{itemize}
			      \item RC4's biases were known but considered impractical to exploit
		...
		\begin{column}{0.6\textwidth}
			\begin{itemize}
				...
				\item \textbf{Key finding:} Single-byte biases
				      \begin{itemize}
					      \item Position 1: $\Pr[Z_1 = 0] \approx 2^{-7}$ (double the expected probability)
					      \item Position 2: $\Pr[Z_2 = 0] \approx 2^{-7}$ (double the expected probability)
	...
	\begin{itemize}
		...
		\item \textbf{The mathematics:} Bias accumulation
		      \begin{itemize}
			      ...
			      \item Required samples: $\mathcal{O}(N \cdot B^{-2})$ where $B$ is the bias
		      \end{itemize}
			...
			\begin{itemize}
				\item \textbf{The improvements:} Orders of magnitude faster
				      \begin{itemize}
					      ...
					      \item Other attack papers use similar techniques; some even break WPA-TKIP, a successor to WEP!\footnote{\url{https://appliedcryptography.page/paper/\#rc4-biases}}
				      \end{itemize}
			\end{itemize}
		\end{column}
	\end{columns}
		...
		\begin{column}{1\textwidth}
			\begin{itemize}
				...
				\item \textbf{The mathematics:} For pattern AB\ldots AB with gap $G$
				      \begin{itemize}
					      \item Expected probability in a random keystream: $1/N^2$
...
\begin{frame}{ABSAB bias in action: practical example}
	\begin{itemize}
		...
		\item \textbf{Step 2:} Look for ABSAB patterns in the collected ciphertexts:
		      \begin{center}
		...
		\item \textbf{Step 3:} After $2^{26}$ samples, frequency analysis reveals:
		      \begin{itemize}
			      ...
			      \item Password structure revealed: ``hell\_\_\_\_''
		      \end{itemize}
	...
	\begin{itemize}
		\item \textbf{Basic Authentication attack performance:}
		      \begin{itemize}
			      ...
			      \item Time: $\approx$50--100 hours
		      \end{itemize}
		\item \textbf{IMAP attack results:}
		      \begin{itemize}
			      \item Real passwords recovered in a laboratory setting
	...
	\begin{itemize}
		...
		\item \textbf{Why this matters for RC4:}
		      \begin{itemize}
			      ...
			      \item POODLE + RC4 biases = no safe ciphers left in SSL 3.0
	...
	\begin{itemize}
		\item \textbf{Lesson 1:} Statistical biases matter at scale
		      \begin{itemize}
			      ...
			      \item The modern internet generates massive data volumes
...
\begin{frame}{RC4: a complete timeline}
	\begin{itemize}
		...
		\item \textbf{1994:} Algorithm leaked to the Cypherpunks mailing list
		...
		\item \textbf{2015:} Garman et al. improve password recovery
	...
	\begin{itemize}
		...
		\item \textbf{Key differences from RC4:}
		      \begin{itemize}
			      ...
			      \item No statistical biases in the keystream
