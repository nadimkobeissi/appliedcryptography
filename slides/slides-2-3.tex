...
\begin{frame}{Recall the example of elliptic curves}
	\begin{columns}[c]
		...
		\end{column}
		\begin{column}{0.5\textwidth}
			\imagewithcaption{elliptic-curve-integers.png}{Elliptic curve over the integers. Source: Serious Cryptography}
		\end{column}
	\end{columns}
\end{frame}
	...
	\begin{columns}[c]
		...
		\begin{column}{0.5\textwidth}
			...
			\begin{itemize}
				...
				\item Killed 11 people including 2 Reuters journalists
