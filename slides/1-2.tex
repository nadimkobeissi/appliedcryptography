...
\begin{frame}{Thinking about secrecy}
	\bigimagewithcaption{naive_enc.png}{Source: The Joy of Cryptography}
\end{frame}
...
\begin{frame}{Thinking about secrecy}
	\begin{columns}[c]
		...
		\column{0.5\textwidth}{
			\imagewithcaption{naive_enc.png}{Source: The Joy of Cryptography}
		}
	\end{columns}
\end{frame}
...
\begin{frame}{Thinking about secrecy}
	\bigimagewithcaption{keyed_enc.png}{\textbf{Concentrate all the need for secrecy in the key!}}
\end{frame}
...
\begin{frame}{Thinking about secrecy}
	\begin{columns}[c]
		...
		\column{0.5\textwidth}{
			\imagewithcaption{keyed_enc.png}{Source: The Joy of Cryptography}
		}
	\end{columns}
\end{frame}
