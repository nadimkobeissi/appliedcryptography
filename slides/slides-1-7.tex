		...
		\begin{column}{0.5\textwidth}
			...
			\begin{itemize}[<+->]
				\item Random instances are typically hard.
				      \begin{itemize}
					      \item \textbf{Example}: Getting $a$ or $b$ if I know $(g, g^a \bmod p, g^b \bmod p, g^{ab} \bmod p)$ (Diffie-Hellman).
	...
	\begin{itemize}[<+->]
		\item \textbf{Why this is bad}:
		      \begin{itemize}
			      ...
			      \item Passive eavesdropper can decrypt connections after the fact
		...
		\item \textbf{Real-world proof}: Researchers decrypted test connections to www.fbi.gov
		      \begin{itemize}
			      \item FBI website used OpenSSL's default 512-bit group until April 2015
