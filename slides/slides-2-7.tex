...
\begin{frame}{Alternative PoW designs: Can we do better?}
	\begin{columns}[c]
		...
		\begin{column}{0.5\textwidth}
			...
			\begin{itemize}
				\item Required 4 GB dataset in RAM
		...
		\begin{column}{0.5\textwidth}
			...
			\begin{itemize}
				...
				\item With 30\% hashpower:
				      \begin{itemize}
					      \item 6 blocks: $\approx$0.5\% success
				      \end{itemize}
			\end{itemize}
	...
	\begin{columns}[c]
		\begin{column}{0.5\textwidth}
			...
			\begin{itemize}
				...
				\item Requirement: $\approx$500 GB
	...
	\begin{columns}[c]
		...
		\begin{column}{0.5\textwidth}
			...
			\begin{alertblock}{Auto-suggestion algorithm}
				Wallet automatically suggests gas price based on current market!
			\end{alertblock}
		\end{column}
	\end{columns}
\end{frame}
	...
	\begin{columns}[c]
		...
		\begin{column}{0.5\textwidth}
			...
			\begin{itemize}
				...
				\item ConstitutionDAO: Attempted to buy US Constitution (\$47M raised!)
			\end{itemize}
			\textbf{Use cases:}
			\begin{itemize}
	...
	\begin{columns}[c]
		...
		\begin{column}{0.5\textwidth}
			...
			\begin{alertblock}{The debate continues}
				Was the fork the right choice? Still controversial in crypto community!
			\end{alertblock}
		\end{column}
	\end{columns}
\end{frame}
	...
	\begin{columns}[c]
		...
		\begin{column}{0.5\textwidth}
			...
			\begin{itemize}
				...
				\item Counter: Staking pools, but adds trust
			\end{itemize}
	...
	\begin{columns}[c]
		\begin{column}{0.5\textwidth}
			...
			\begin{itemize}
				...
				\item Post results to Ethereum smart contract
