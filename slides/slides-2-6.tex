		...
		\begin{column}{0.68\textwidth}
			\begin{enumerate}
				\item \textbf{Three families, three very different bets}
				      \begin{itemize}
					      \item Lattices: fast and small, 20-year-old assumptions. Codes: 50-year-old assumptions, 100 KB keys. Hashes: the weakest assumption, but signatures only. Which would you trust with a 30-year secret?
				      \end{itemize}
