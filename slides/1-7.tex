...
\coversessionname{1.7: Hard Problems \&\\Diffie-Hellman}
...
\begin{frame}{The million-dollar question}
	\begin{itemize}[<+->]
		...
		\item \textbf{To win}: Prove either P = NP or P ≠ NP.
...
\begin{frame}{Why we don't panic}
	\begin{itemize}[<+->]
		\item \textbf{Overwhelming consensus}: Most complexity theorists believe P ≠ NP.
	...
	\definitionbox{The Challenge}{
		\begin{itemize}
			...
			\item \textbf{Proving P ≠ NP}: Must prove no such algorithm can \textbf{ever} exist—much harder!
		\end{itemize}
	}
\end{frame}
...
\begin{frame}{Why NP-complete problems don't work for cryptography}
	\begin{itemize}[<+->]
		...
		\item \textbf{The dream}: Prove that breaking some cipher is NP-hard.
		      \begin{itemize}
			      \item Security would be guaranteed as long as P ≠ NP.
		      \end{itemize}
...
\begin{frame}{Real-world Diffie-Hellman}
	...
	\definitionbox{Modern Diffie-Hellman Variants}{
		...
		\vspace{0.1em}
		\begin{center}
			More on both of the above in future course sessions!
		\end{center}
	}
\end{frame}
