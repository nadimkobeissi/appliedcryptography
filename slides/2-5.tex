...
\begin{frame}{Breaking news: First verified Rust crypto protocol!}
	\bigimagewithcaption{verified_rust_a.png}{Source: Karthikeyan Bhargavan, Lasse Letager Hansen, Franziskus Kiefer, Jonas Schneider-Bensch and Bas Spitters, Formal Security and Functional Verification of Cryptographic Protocol Implementations in Rust, IACR Cryptology ePrint Archive, 2025.}
\end{frame}
...
\begin{frame}{One codebase, three provers, thorough verification}
	\bigimagewithcaption{verified_rust_b.png}{Source: Karthikeyan Bhargavan, Lasse Letager Hansen, Franziskus Kiefer, Jonas Schneider-Bensch and Bas Spitters, Formal Security and Functional Verification of Cryptographic Protocol Implementations in Rust, IACR Cryptology ePrint Archive, 2025.}
\end{frame}
