...
\begin{frame}{The Merkle-Damgård construction}{SHA-3, BLAKE}
	\begin{columns}[c]
		\begin{column}{0.45\textwidth}
			\begin{itemize}[<+->]
				\item Key components:
...
\begin{frame}{The Sponge Construction}{SHA-3's innovative design}
	\begin{columns}[c]
		\begin{column}{0.55\textwidth}
			\begin{itemize}[<+->]
				\item Two phases:
...
\begin{frame}{"Migrate to stronger algorithms?"}{Introducing protocol agility}
	\begin{itemize}[<+->]
