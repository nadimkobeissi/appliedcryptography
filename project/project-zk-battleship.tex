...
\subject{Design and implementation of a zero-knowledge proof-based battleship game using the RISC Zero zkVM for verifiable gameplay without revealing sensitive game state.}
...
\begin{enumerate}
	...
	\item \textbf{User Interface:}
	      \begin{itemize}
		      \item Create a simple CLI for gameplay.
...
\begin{itemize}
	...
	\item Prepare a 10-minute presentation demonstrating your zero-knowledge battleship game.
\end{itemize}
