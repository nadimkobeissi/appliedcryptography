...
\title{Applied Cryptography - Project C: Designing and Verifying a TLS-like Protocol Using ProVerif}
...
\begin{itemize}
	...
	\item Verification is performed automatically, even for an unbounded number of protocol sessions.
	\item ProVerif uses a symbolic model of cryptography to reason about cryptographic primitives.
\end{itemize}
...
\begin{itemize}
	\item Model cryptographic primitives using ProVerif's constructors and destructors.
...
\begin{itemize}
	...
	\item TLS 1.3 specification (RFC 8446) for reference.
...
\begin{itemize}
	...
	\item Prepare a 10-minute presentation demonstrating your protocol design and verification results.
\end{itemize}
