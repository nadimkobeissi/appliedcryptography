...
\subsection*{Overview}
This project focuses on building a secure messaging application implementing end-to-end encryption. You'll work with cryptographic libraries to implement key exchange protocols, message encryption, and authentication mechanisms. The project covers essential features like forward secrecy, deniability, and authenticated key exchange. You'll also explore practical challenges such as key verification, metadata protection, and secure key storage on devices. By the end of this project, you'll understand the cryptographic foundations behind modern secure messaging platforms like Signal.
...
\begin{enumerate}
	...
	\item \textbf{User Interface:}
	      \begin{itemize}
		      \item Create a simple CLI or GUI for interaction.
		      ...
		      \item Add a timeout for automatic logout.
...
\begin{itemize}
	...
	\item Libraries: libsodium, OpenSSL, or Signal Protocol libraries based on your language choice.
	\item Research papers on secure messaging protocols (see course website).
	\item Specifications for the Signal Protocol, OTR, or Matrix.
\end{itemize}
...
\begin{itemize}
	...
	\item Prepare a 10-minute presentation demonstrating your secure messenger.
\end{itemize}
