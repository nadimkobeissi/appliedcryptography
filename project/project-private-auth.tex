...
\subject{Project exploring privacy-preserving age verification systems using zero-knowledge proofs and anonymous credentials.}
...
\begin{itemize}
	...
	\item Analyze and address practical challenges, including credential revocation and sharing prevention.
\end{itemize}
...
\begin{enumerate}
	...
	\item \textbf{Unlinkability and Privacy:}
	      \begin{itemize}
		      \item Implement unlinkable showing protocols that prevent correlation across sessions.
	...
	\item \textbf{Practical Security Features:}
	      \begin{itemize}
		      ...
		      \item Handle edge cases like leap years and time zones.
	      \end{itemize}
\end{enumerate}
...
\begin{itemize}
	\item What attributes need to be included? (birthdate, issuance date, expiry date, and a unique ID for revocation)
...
\begin{itemize}
	...
	\item Ensure the issuer cannot track credential usage, even if it colludes with verifiers.
\end{itemize}
...
\begin{itemize}
	...
	\item Prepare a 10-minute presentation demonstrating your privacy-preserving age verification system and its privacy guarantees.
\end{itemize}
