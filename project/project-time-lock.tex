...
\subject{Project exploring timelock encryption using distributed randomness beacons to create messages that can only be decrypted at specified future times.}
...
\begin{itemize}
	...
	\item Messages are encrypted to future rounds whose beacon values don't yet exist, ensuring they cannot be decrypted until the beacon publishes them.
...
\begin{enumerate}
	...
	\item \textbf{Web Application:}
	      \begin{itemize}
		      ...
		      \item Provide options for different unlock times (hours, days, or years into the future).
	      \end{itemize}
...
Begin by establishing a reliable connection to the drand beacon:
\begin{itemize}
...
\begin{itemize}
	...
	\item Nicolas Gailly, Kelsey Melissaris, and Yolan Romailler, \href{https://appliedcryptography.page/paper/\#tlock-bls}{\emph{tlock: Practical Timelock Encryption from Threshold BLS}}, Cryptology ePrint Archive, 2023.
...
\begin{itemize}
	...
	\item Prepare a 10-minute presentation demonstrating your time capsule system with live examples of message encryption and scheduled decryption.
\end{itemize}
