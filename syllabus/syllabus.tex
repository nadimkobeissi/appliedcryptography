...
Lab projects will be worked on weekly during lab sessions intended to serve as a hands-on complement to the lectures. Each group of (one to three) students is expected to pick one (or, if you're feeling adventurous, at most two) lab topics and work on them throughout the entire course. During each lab, you will experiment with real-world libraries, and even simulate attacks or vulnerabilities to understand why certain security practices are necessary. These sessions will also help you become comfortable with relevant tools and environments, including formal analysis tools. After discussions with the department, it was determined that Lab Sessions will be optional since the mix of 60+ graduate and undergraduate students is making it impossible to find a time and place that accommodates everyone. However, attendance is strongly recommended: labs offer an excellent opportunity for collaborative problem-solving and immediate feedback on your work. Labs offer an excellent opportunity for collaborative problem-solving and immediate feedback on your work.
