...
\begin{itemize}
	...
	\item \textbf{Lab progress discussions:} Students will be encouraged to openly discuss their progress on projects as they work, allowing for real-time problem-solving and knowledge sharing.
...
Lectures and labs start on time. You may not be allowed to come into the room once class has started. Any class conduct that disturbs the learning atmosphere may be deemed misbehavior and will not be tolerated.
