...
\begin{questions}
	\question[15] \textbf{Threat Models and Key Management}
	...
	\begin{parts}
		\part[10] \textbf{OPAQUE and Password Authentication:}
...
\begin{questions}
	\question[18] \textbf{MEGA Attack Analysis}
	...
	\begin{parts}
		...
		\part[8] \textbf{Plaintext Recovery:}
	...
	\question[12] \textbf{Nextcloud Vulnerabilities}

	\begin{parts}
		\part[6] \textbf{Authentication Failures:}
...
\begin{questions}
	\question[10] \textbf{HSM-Based Key Recovery}

	\begin{parts}
		\part[10] \textbf{System Design and OPAQUE:}
...
\begin{questions}
	\question[15] \textbf{Formal Protocol Design}
