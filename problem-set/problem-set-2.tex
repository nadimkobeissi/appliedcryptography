...
\keywords{pseudorandom generators, PRF, PRP, stream ciphers, Feistel ciphers, CPA security, CCA security, authenticated encryption, AES-GCM, hash functions, collision resistance, password hashing, block cipher modes}
