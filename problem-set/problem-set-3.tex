...
\begin{questions}
	...
	\begin{parts}
		\part[7.5] \textbf{The Government Backdoor Controversy:}
		...
		\part[7.5] \textbf{The Invalid Curve Attack Scenario:}
	...
	\begin{parts}
		\part[7.5] \textbf{Side-Channel Attack Laboratory:}
		...
		\part[7.5] \textbf{The Ed25519 Validation Crisis:}
...
\begin{questions}
	...
	\begin{parts}
		\part[3] Compare ECDSA and Ed25519 for each requirement above. Which algorithm better meets each criterion and why?
		\part[3] Discuss the implications of signature malleability. How does this affect each algorithm and why might it matter for cryptocurrency applications?
		\part[3] Analyze the quantum resistance of both options. What migration path would you recommend for long-term security?
		\part[3] Consider the ecosystem effects: existing wallet software, hardware support, and developer familiarity. How do these practical factors influence the decision?
		\part[3] Make a final recommendation with justification, considering both technical and practical factors.
	\end{parts}
	...
	\begin{parts}
		\part[3] Specify your cryptographic algorithm choices for:
		\begin{itemize}
		...
		\end{itemize}
		\part[3] Describe your key management architecture. How do you bootstrap trust, distribute keys, and handle key rotation?
		\part[3] Analyze your system's security properties against various attack scenarios:
		\begin{itemize}
		...
		\end{itemize}
		\part[3] Discuss the performance implications of your design choices and how you would optimize for a large-scale deployment.
		\part[3] Evaluate your system's compliance with modern security standards and its readiness for post-quantum cryptography migration.
	\end{parts}
\end{questions}
