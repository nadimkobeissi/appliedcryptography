...
\begin{questions}
	\question[10] \textbf{Breaking Cryptography: Attack Scenarios}\topicbadge{1.7}
	...
	\begin{parts}
		...
		A security researcher discovers that a popular cryptographic library has been generating Diffie-Hellman parameters where the prime $p$ is such that $p-1$ has many small factors, making 75\% of generated groups vulnerable to Pohlig-Hellman attacks.
		\begin{subparts}
	...
	\question[10] \textbf{Discrete Logarithm Security Architecture}\topicbadge{1.7}
...
\begin{questions}
	\question[10] \textbf{Attack and Defense Scenarios}\topicbadge{1.7}
	...
	\question[10] \textbf{Protocol Design Challenge}\topicbadge{1.7}
...
\begin{questions}
	\question[15] \textbf{Curve Selection Under Pressure}\topicbadge{1.8}
	...
	\question[15] \textbf{Implementation Vulnerability Analysis}\topicbadge{1.8}
	...
	\begin{parts}
		...
		\begin{subparts}
			\subpart Design a timing attack against ECDSA. Which two operations could you attempt to differentiate between?
...
\begin{questions}
	\question[15] \textbf{Cryptocurrency Signature Scheme Analysis:}\topicbadge{1.8}
	...
	\question[15] \textbf{Secure Communication System Architecture:}\topicbadge{1.7}
...
\begin{tcolorbox}[colframe=EarthBrown!30!white,colback=EarthBrown!5!white]
	...
	\begin{questions}
		\bonusquestion[10] The transition to post-quantum cryptography will require replacing current elliptic curve systems with quantum-resistant alternatives. Research and analyze one of the following aspects of this transition:
		\begin{parts}
		...
		\end{parts}
		Your answer should include: current standardization status, performance comparisons with existing systems, deployment challenges, and recommendations for practitioners preparing for the post-quantum transition. Check the Optional Readings under the topic listing for Post-Quantum Cryptography on the course website for helpful references!
	\end{questions}
\end{tcolorbox}
