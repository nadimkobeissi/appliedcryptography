...
\begin{questions}
	...
	\begin{parts}
		...
		The following protocol attempts to provide authenticated key exchange. Identify whether it is vulnerable to identity misbinding, key compromise impersonation (KCI), replay attacks, or lack perfect forward secrecy.
