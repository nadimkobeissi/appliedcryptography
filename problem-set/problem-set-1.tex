...
\begin{questions}
	\question[10] \textbf{Basic Concepts}\topicbadge{1.1}
	...
	\begin{parts}
		...
		\part[3] Explain Kerckhoffs' principle and why it remains fundamental to modern cryptography. Provide an example of a security system that violates this principle and describe the potential consequences.

		\part[4] Compare and contrast symmetric and asymmetric cryptography:
		\begin{subparts}
			\subpart Explain the fundamental difference in their key management approaches.
	...
	\question[10] \textbf{Perfect Secrecy}\topicbadge{1.2}
...
\begin{questions}
	\question[10] \textbf{Libraries and Indistinguishability}\topicbadge{1.2}
	...
	\question[10] \textbf{Security Proofs}\topicbadge{1.2}
...
\begin{questions}
	\question[15] \textbf{Computational Security Concepts}\topicbadge{1.3}
	...
	\question[15] \textbf{Distinguishability}\topicbadge{1.3}
...
\begin{questions}
	\question[15] \textbf{One-Time Pad in the Real World}\topicbadge{1.2}
	...
	\begin{itemize}
		...
		\item During account registration, each user receives a 1TB USB drive containing pre-generated pad data.
	...
	\question[15] \textbf{Symmetric Encryption Protocol Analysis}\topicbadge{1.2}
	...
	\begin{itemize}
		...
		\item The company claims their protocol is ``as secure as the one-time pad'' because they use the XOR operation.
	\end{itemize}
...
\begin{tcolorbox}[colframe=EarthBrown!30!white,colback=EarthBrown!5!white]
	\section*{Bonus Question\hfill\topicpill{1.7}}
	\begin{questions}
		\bonusquestion[10] The discrete logarithm problem is fundamental to many cryptographic systems. Consider a cyclic group $G$ of prime order $p$ with generator $g$. The discrete logarithm problem is: given $h \in G$, find $x$ such that $g^x = h$.
